...
Requirements:
- A modern C++ compiler (GCC/Clang) supporting C++11 or later

Build and run (example using g++):

```bash
g++ -std=c++11 -Wall -Wextra CY_24_OOP/main.cpp -o cy_oop
./cy_oop
```

## 🧩 How to Contribute

Contributions are welcome! Please fork the repository, make changes on a feature branch, and open a pull request describing your changes.
